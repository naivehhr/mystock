...
import './PortfolioUploadModal.css'
...
function PortfolioUploadModal({ isOpen, onClose, onUpload }: Props) {
  ...
  const handleClose = () => {
    setPositions([initialPositionForm])
    setErrors({})
    onClose()
  }
      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <div className="modal-title-group">
            <h2 className="modal-title">录入持仓数据</h2>
            <p className="modal-subtitle">添加您的股票持仓信息，开始智能分析</p>
          </div>
        ...
        <div className="modal-body">
          ...
          <div className="field-legend">
            <div className="legend-item">
              ...
              <span className="legend-text">必填字段</span>
            </div>
            <div className="legend-item">
              <span className="legend-mark optional"></span>
              <span className="legend-text">选填（填写后可计算盈亏）</span>
            </div>
          </div>
